...
export default function Button({
  ...
  const cmn =
    "group  text-white leading-none font-bold text-sm lg:text-base py-3.5  flex items-center justify-center rounded-[10px] box-content transitions-all duration-[0.4s]";
  const styles = {
    filled: {
      hovered:
